        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('이메일 간편가입', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.wabizGray[900]),),
                Gap(20),
                Text('이메일 계정', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                Gap(12),
                Row(
                  children: [
                    Expanded(
                ...
                Gap(20),
                Text('이름', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                Gap(12),
                TextFormField(
                ...
                Gap(20),
                Text('비밀번호', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                Gap(12),
                TextFormField(
                        ...
                        if (formKey.currentState!.validate()) {
                          ...
                          if (!validated) {
                            showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  content: Text('이메일 중복확인을 체크해 주세요.'),
                                );
                              }
                            );
                            return;
                          ...
                          if (result) {
                            if (context.mounted) {
                              showDialog(
                                context: context,
                                builder: (context) => AlertDialog(
                                  content: Text('등록 성공: 로그인을 진행해 주세요.'),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                        context.pop();
