          ...
          children: [
            ...
            ButtonBar(
              children: [
                TextButton(
                  onPressed: () {},
                  child: Text('로그인 정보를 잊으셨나요?', style: TextStyle(color: AppColors.wabizGray[600]),)
                ),
              ],
            ),
            Gap(24),
              ...
              builder: (context, ref, child) {
                return GestureDetector(
                  onTap: () async {
                    ...
                    final result = await ref.read(loginViewModelProvider.notifier)
                        .signIn(emailTextController.text.trim(), passwordTextController.text.trim());
