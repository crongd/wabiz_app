...
import 'package:wabiz_app/view_model/my/my_view_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        titleTextStyle: TextStyle(fontWeight: FontWeight.w600, fontSize: 20, color: AppColors.wabizGray[900]),
      ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const Gap(4),
                                    const Text('로그인 후 다양한 프로젝트에 참여해보세요.', style: TextStyle(fontWeight: FontWeight.w400,),),
                                  ],
                                ),
                              ],
                            );
                      ...
                      Consumer(
                        builder: (context, ref, child) {
                          final isLogin = ref.watch(myPageViewModelProvider).loginState ?? false;
                          ...
                          return FutureBuilder(
                            future: ref.read(myPageViewModelProvider.notifier).fetchUserProjects(),
                            builder: (context, snapshot) {
                              if (snapshot.hasData) {
                                List<ProjectItemModel> items = snapshot.data ?? [];
                                if (items.isEmpty) {
                                        ...
                                        Expanded(
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ProjectItemModel project = items[index];
                                                      ...
                                                      PopupMenuItem(
                                                        ...
                                                        onTap: () {
                                                          showDialog(
                                                            context: context,
                                                            builder: (context) {
                                                              bool openState = project.isOpen == 'open' ? true : false;
                                                                ...
                                                                builder: (context, setState) {
                                                                  return AlertDialog(
                                                                    ...
                                                                    actions: [
                                                                      TextButton(
                                                                        onPressed: () async {
                                                                          final result = await ref.read(myPageViewModelProvider.notifier).updateProject(project.id.toString(), ProjectItemModel(
                                                              ...
                                                              builder: (context) {
                                                                return AlertDialog(
                                                                  ...
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed: () async {
                                                                        final result = await ref.read(myPageViewModelProvider.notifier).deleteProject(project.id.toString());
                                                                        if (result) {
                                                                          if (context.mounted) {
                                                                            Navigator.pop(context);
                                                                            setState(() {});
