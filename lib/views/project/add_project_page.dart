...
import 'package:wabiz_app/shared/enum/enum_project_class.dart';
...
import 'package:wabiz_app/view_model/project/project_view_model.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                              ...
                              child: Consumer(
                                builder: (context, ref, child) {
                                  ...
                                  return switch (types) {
                                    ...
                                    AsyncError(:var error) => Text(error.toString()),
                                    _ => const Center(
                ...
                child: Column(
                  children: [
                    ...
                    RadioListTile(
                      ...
                      onChanged: (v) {
                        setState(() {
                          enumProjectClass = v ?? EnumProjectClass.freeOrderGlobal;
                        });
                      },
                      title: Text(EnumProjectClass.freeOrderGlobal.title ?? ''),
                      subtitle: Text(EnumProjectClass.freeOrderGlobal.subtitle ?? ''),
                    ),
                    RadioListTile(
                      ...
                      onChanged: (v) {
                        setState(() {
                          enumProjectClass = v ?? EnumProjectClass.freeOrderEncore;
                        });
                      },
                      title: Text(EnumProjectClass.freeOrderEncore.title ?? ''),
                      subtitle: Text(EnumProjectClass.freeOrderEncore.subtitle ?? ''),
                    ),
                  ],
                ),
              ),
              ...
              Gap(12),
              Text('최소 50만 원 ~ 최대 1억 원 사이에서 설정해 주세요.'),
              Gap(12),
              TextFormField(
              ...
              Gap(12),
              Text(
                '소개 영상이나 사진과 함께 보이는 글이에요. 프로젝트를 쉽고 간결하게 소개해 주세요.',
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w500,
                  color: AppColors.wabizGray[400],
