...
class _ProjectDetailPageState extends State<ProjectDetailPage> {
  ...
  void initState() {
    super.initState();
    projectItemModel = widget.project;
  }
              ...
              children: [
                IconButton(
                  onPressed: () {
                          ...
                          builder: (context) {
                            return AlertDialog(
                              ...
                              actions: [
                                TextButton(
                                    onPressed: () {
                                      ref.read(favoriteViewModelProvider.notifier).removeItem(CategoryItemModel(id: projectItemModel.id));
                    ...
                    ref.read(favoriteViewModelProvider.notifier).addItem(CategoryItemModel(
